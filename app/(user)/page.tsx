  ...
  return (
    ...
    >
      ...
      <section className="relative flex flex-col items-center justify-center w-full bg-light-beige overflow-hidden">
        ...
        <div className="container mx-auto grid grid-cols-1 lg:grid-cols-3 lg:[&>*:first-child]:col-span-1 lg:[&>*:last-child]:col-span-2 mt-8 mb-8 bg-light-green rounded-2xl shadow-lg ">
